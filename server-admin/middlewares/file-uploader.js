...
// Uploader para imágenes de users
export const uploadUserImage = createCloudinaryUploader(
    process.env.CLOUDINARY_USERS_FOLDER || 'facekinal/user-logos'
);

// Uploader para imágenes de publicaciones
export const uploadPublicationImage = createCloudinaryUploader(
    process.env.CLOUDINARY_PUBLICATIONS_FOLDER || 'facekinal/publications'
);
